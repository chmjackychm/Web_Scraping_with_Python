...
depart_time = datetime.date(now.year, now.month, now.day)
depart_time = datetime.date(2016, 7, 7)
departure_time_candidate = [depart_time + timedelta(days=n) for n in range(5, 180, 15)]

for fill_depart in departure_time_candidate:
    for flexiable_date in range(3):
...
writer = pd.ExcelWriter("C:/Users/jchen5/Downloads/ANA v2.xlsx")
